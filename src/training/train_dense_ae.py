...
from src.models.dense_ae import Autoencoder
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a dense autoencoder TSAD model.")
...
def main():
    ...
    run_dir = make_run_dir(
        args.run_root, args.dataset, "tsad", "dense_ae", args.model_seed
    )
    ...
    print(f"Saved dense autoencoder run to {run_dir}")
