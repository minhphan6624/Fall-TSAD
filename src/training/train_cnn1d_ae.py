...
from src.models.cnn1d_ae import CNN1D_AE
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a CNN1D autoencoder TSAD model.")
...
def main():
    ...
    model = CNN1D_AE(in_channels=data["train"]["X"].shape[2])
    ...
    run_dir = make_run_dir(
        args.run_root, args.dataset, "tsad", "cnn1d_ae", args.model_seed
    )
    ...
    print(f"Saved CNN1D autoencoder run to {run_dir}")
