...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a 1D CNN classifier.")
...
def main():
    ...
    model = CNN1D(in_channels=data["train"]["X"].shape[2])
    ...
    run_dir = make_run_dir(
        args.run_root, args.dataset, "classification", "cnn1d", args.model_seed
    )
    ...
    print(f"Saved CNN1D run to {run_dir}")
